...
\item OpenType-CFF fonts were poorly supported in Java, and so we had
recommended use of the TTF versions in Java programming situations. This problem
appears to have been resolved in Oracle Java SE 7.
...
turning off and on Graphite features is available starting with LibreOffice version 4.1.
...
\newfontfamily{\left}[StylisticSet=2,HyphenChar="200B]{Fedorovsk Unicode}
